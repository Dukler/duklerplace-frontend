...
import { ChangeEvent, Dispatch, Fragment, SetStateAction, SyntheticEvent, useRef, useState } from 'react'
...
export default function Modal({ onChangeHandler, onClickHandler, open, setOpen }:Props) {
