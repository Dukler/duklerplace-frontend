...
function MyApp({ Component, pageProps }: AppProps) {
  const { isConnected, connect, ethers, signer, account } = useWeb3();
  ...
  return <Layout web3Handler={connect} account={account}> {!loading ? <Component {...pageProps} {...blockchainProps} /> : null} </Layout>
}
